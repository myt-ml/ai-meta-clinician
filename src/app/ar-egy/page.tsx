        ...
        setRiskAlert({
          ...
          message:
            result.riskLevel === "critical"
              ? "⚠️ عاجل: في أزمة! اتصل بالطوارئ حالاً."
              : result.riskLevel === "high"
              ? "⚠️ في خطر كبير. لازم تروح لدكتور قريب."
              : "ملاحظة: في حاجات مش مطمئنة. يفضل تستشير حد متخصص.",
        });
      }
  ...
  return (
    <div className="min-h-screen flex flex-col" dir="rtl">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-primary">
                الدكتور الذكي للصحة النفسية
              </h1>
              <p className="text-sm text-gray-600">
                منصة الدعم النفسي - العامية المصرية
              </p>
            </div>
      ...
      <footer className="border-t border-subtle py-4 text-center text-sm text-gray-600">
        <p>⚠️ ده مش بديل للعلاج النفسي الحقيقي</p>
        <p className="mt-1">
          لو في أزمة، اتصل بـ <strong>08008880700</strong> (مصر) أو زور{" "}
          <a
