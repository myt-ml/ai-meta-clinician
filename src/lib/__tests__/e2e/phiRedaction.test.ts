...
describe("PHI Redaction Tests", () => {
  describe("Name Redaction", () => {
    ...
    it("should handle multiple names in text", () => {
      ...
      expect((redacted.match(/\[NAME\]/g) || []).length).toBeGreaterThanOrEqual(
        3
      );
    });
  });
  ...
  describe("Complete Message Redaction", () => {
    it("should redact all PHI types in one message", () => {
      const message =
        "My name is John Smith, I live at 123 Main St in Boston, MA 12345. " +
    ...
    it("should preserve clinical context while redacting", () => {
      const message =
        "I am John and I feel depressed. I have suicidal thoughts.";
      const result = redactMessage(message, {
        enabled: true,
        aggressiveness: "standard",
        preserveContext: true,
  ...
  describe("Pilot Log Entry Creation", () => {
    it("should create metadata-only log entries", () => {
      const entry = createPilotLogEntry("session-abc123", 0, {
        riskLevel: "moderate",
        language: "en",
        responseTime: 1500,
        modelUsed: "ollama",
  ...
  describe("PHI Verification", () => {
    it("should detect PHI in logs", () => {
      const badLog = createPilotLogEntry("session-1", 0, {
        riskLevel: "low",
        language: "en",
        responseTime: 1000,
        modelUsed: "ollama",
  ...
  describe("Real-World Scenarios", () => {
    it("should handle crisis message with PHI", () => {
      const message =
        "My name is Sarah and I want to kill myself. Call me at 555-1234.";
      const result = redactMessage(message, {
        enabled: true,
        aggressiveness: "standard",
        preserveContext: true,
