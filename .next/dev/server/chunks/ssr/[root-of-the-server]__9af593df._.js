...
"[project]/src/lib/validation/validator.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function validateResponse(response, context) {
    ...
    for (const filter of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["HARMFUL_PATTERNS"]){
    ...
    for (const filter of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["SCOPE_VIOLATIONS"]){
        const detected = detectPattern(response, filter.patterns);
        if (detected) {
            violations.push({
                type: filter.category,
 ...
 */ function getDisclaimer(context, language) {
    const template = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DISCLAIMER_TEMPLATES"].find((t)=>t.context === context && t.language === language);
    if (template) return template;
    // Fallback to general disclaimer in same language
    const generalTemplate = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DISCLAIMER_TEMPLATES"].find((t)=>t.context === "general" && t.language === language);
    if (generalTemplate) return generalTemplate;
    // Final fallback to English general
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DISCLAIMER_TEMPLATES"].find((t)=>t.context === "general" && t.language === "en");
}
/**
...
"[project]/src/lib/validation/disclaimer.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function enforceDisclaimer(message, context) {
    ...
    if (!disclaimer) {
        ...
        const fallback = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DISCLAIMER_TEMPLATES"].find((t)=>t.context === "general" && t.language === "en");
 ...
 */ function getApplicableDisclaimer(context, language) {
    // Try exact match
    const exactMatch = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DISCLAIMER_TEMPLATES"].find((t)=>t.context === context && t.language === language);
    if (exactMatch) return exactMatch;
    // Try same context in English
    const englishMatch = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DISCLAIMER_TEMPLATES"].find((t)=>t.context === context && t.language === "en");
    if (englishMatch) return englishMatch;
    // Try general in same language
    const generalMatch = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DISCLAIMER_TEMPLATES"].find((t)=>t.context === "general" && t.language === language);
...
function getDisclaimerText(context, language) {
    const disclaimer = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DISCLAIMER_TEMPLATES"].find((t)=>t.context === context && t.language === language);
 ...
 */ __turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/validation/types.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/validation/validator.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$disclaimer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/validation/disclaimer.ts [app-ssr] (ecmascript)");
;
;
;
}),
"[project]/src/lib/llm/ollamaClient.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/llm/router.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/llm/ollamaClient.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$llm$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/llm/llm.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$prompts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/llm/prompts.ts [app-ssr] (ecmascript)");
;
;
...
async function initializeRouter() {
    const health = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["checkOllamaHealth"])();
 ...
 */ function selectOllamaModel(taskType, language) {
    ...
    if (language === "ar") {
        const arabicModel = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OLLAMA_MODELS"].find((m)=>m.task === "arabic");
    ...
    if (taskType === "safety") {
        const safetyModel = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OLLAMA_MODELS"].find((m)=>m.task === "safety");
        if (safetyModel && ollamaModels.includes(safetyModel.name)) {
            return safetyModel;
        }
    }
    // General clinical reasoning → use Llama
    const generalModel = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OLLAMA_MODELS"].find((m)=>m.task === "general");
...
async function routeInference(userMessage, conversationHistory, riskLevel, language, taskType = "general", strategy = {
    ...
    // Build prompt
    const prompt = riskLevel === "critical" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$prompts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildCrisisPrompt"])(userMessage) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$prompts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["buildPrompt"])(userMessage, conversationHistory, riskLevel);
    ...
    if (strategy.preferLocal && ollamaAvailable) {
        ...
        if (selectedModel) {
            try {
                ...
                const startTime = Date.now();
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ollamaQuery"])(selectedModel.name, prompt, {
                    temperature: 0.7,
                    maxTokens: 1000,
    ...
    try {
        ...
        return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$llm$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateResponse"])(userMessage, conversationHistory, riskLevel, "webllm");
    } catch (error) {
...
function getRecommendedModels() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OLLAMA_MODELS"];
}
async function getMissingModels() {
    await refreshHealthCheck();
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OLLAMA_MODELS"].filter((model)=>!ollamaModels.includes(model.name));
}
...
Respond with JSON only:
{
  ...
  "reason": "brief explanation if unsafe"
        ...
        const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ollamaQuery"])(safetyModel.name, prompt, {
            temperature: 0.3,
            maxTokens: 200,
            timeout: 5000
        });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/validation/validator.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$disclaimer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/validation/disclaimer.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$router$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/llm/router.ts [app-ssr] (ecmascript)");
;
;
;
;
async function generateClinicalResponse(userMessage, clinicalState) {
    ...
    try {
        const localSafetyCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$router$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["runLocalSafetyCheck"])(userMessage);
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$llm$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isModelReady"])() && !llm.fallbackActive && llm.status === "ready") {
        try {
            ...
            const llmResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$router$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["routeInference"])(userMessage, messages, currentRiskLevel, language, "general", {
                preferLocal: true,
                allowFallback: true,
                timeout: 30000
            });
...
function generateOfflineResponse(userMessage, clinicalState) {
    ...
    // 2. GENERATE RESPONSE
    let response = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$reasoning$2f$mhgap$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["generateClinicalResponse"])(assessment, language);
    // 2a. VALIDATE OFFLINE RESPONSE
    const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateResponse"])(response, {
        riskLevel: assessment.riskLevel,
        language,
        isAssessment: false,
        containsMedication: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["containsMedicalAdvice"])(response)
    });
    ...
    response = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$disclaimer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["enforceDisclaimer"])(response, {
        riskLevel: assessment.riskLevel,
        language,
...
"[project]/src/lib/__tests__/audit.test.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function runAuditTests() {
    ...
    try {
        ...
        const auditModule = await __turbopack_context__.A("[project]/src/lib/audit/index.ts [app-ssr] (ecmascript, async loader)");
    ...
    try {
        ...
        const { logAudit } = await __turbopack_context__.A("[project]/src/lib/audit/index.ts [app-ssr] (ecmascript, async loader)");
    ...
    try {
        ...
        const { logClinicalDecision } = await __turbopack_context__.A("[project]/src/lib/audit/index.ts [app-ssr] (ecmascript, async loader)");
    ...
    try {
        ...
        const { logSafetyEscalation } = await __turbopack_context__.A("[project]/src/lib/audit/index.ts [app-ssr] (ecmascript, async loader)");
    ...
    try {
        ...
        const { queryAuditLogs, flushAuditLogs } = await __turbopack_context__.A("[project]/src/lib/audit/index.ts [app-ssr] (ecmascript, async loader)");
    ...
    try {
        ...
        const { exportAuditLogs } = await __turbopack_context__.A("[project]/src/lib/audit/index.ts [app-ssr] (ecmascript, async loader)");
...
"[project]/src/lib/__tests__/validation.test.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const validationTests = [
    // Test 1: Detect harmful medical diagnosis
    {
        ...
        fn: ()=>{
            ...
            const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateResponse"])(response, {
                riskLevel: "high",
                language: "en"
            });
    ...
    // Test 5: Disclaimer enforcement for crisis
    {
        ...
        fn: ()=>{
            ...
            const withDisclaimer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$disclaimer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["enforceDisclaimer"])(response, {
                riskLevel: "critical",
                language: "en",
                isCrisis: true
            });
    ...
    // Test 6: Disclaimer enforcement for assessment
    {
        ...
        fn: ()=>{
            ...
            const withDisclaimer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$disclaimer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addAssessmentDisclaimer"])(response, "en");
    ...
    // Test 7: Detect medical advice presence
    {
        ...
        fn: ()=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["containsMedicalAdvice"])(medical) && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["containsMedicalAdvice"])(nonMedical);
        },
        category: "validation"
    },
    // Test 8: Validate response length
    {
        ...
        fn: ()=>{
            ...
            const shortResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateLength"])(tooShort);
            const goodResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateLength"])(justRight);
            const longResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateLength"])(tooLong);
    ...
    // Test 10: Sanitize harmful content
    {
        ...
        fn: ()=>{
            ...
            const sanitized = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sanitizeResponse"])(response, violations);
    ...
    // Test 11: Has disclaimer detection
    {
        ...
        fn: ()=>{
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$disclaimer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hasDisclaimer"])(withDisclaimer, "en") && !(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$disclaimer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hasDisclaimer"])(without, "en");
        },
        category: "validation"
    },
    ...
    // Test 13: Emergency disclaimer content
    {
        ...
        fn: ()=>{
            ...
            const withEmergency = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$disclaimer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addEmergencyDisclaimer"])(response, "en");
    ...
    // Test 14: Medication disclaimer clarity
    {
        ...
        fn: ()=>{
            ...
            const withMedDisclaimer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$disclaimer$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addMedicationDisclaimer"])(response, "en");
    ...
    // Test 17: Validate risk level propagation
    {
        ...
        fn: ()=>{
            ...
            const criticalResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateResponse"])(response, {
                riskLevel: "critical",
                language: "en"
            });
            const lowResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validation$2f$validator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateResponse"])(response, {
                riskLevel: "low",
                language: "en"
            });
...
"[project]/src/lib/__tests__/ollama.test.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ollamaTests = [
    ...
    // Test 2: Router initialization
    {
        ...
        fn: async ()=>{
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$router$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initializeRouter"])();
            const available = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$router$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isOllamaAvailable"])();
    ...
    // Test 3: Check available models
    {
        ...
        fn: async ()=>{
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$router$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initializeRouter"])();
            const models = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$router$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAvailableOllamaModels"])();
    ...
    // Test 4: Check missing models
    {
        ...
        fn: async ()=>{
            const missing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$router$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMissingModels"])();
    ...
    // Test 5: Local safety check (if Ollama available)
    {
        ...
        fn: async ()=>{
            ...
            try {
                ...
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$router$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["runLocalSafetyCheck"])(safeMessage);
    ...
    // Test 6: Ollama query (if server available)
    {
        ...
        fn: async ()=>{
            ...
            const availableModel = health.models.find((m)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OLLAMA_MODELS"].some((om)=>m.startsWith(om.name.split(":")[0])));
            if (!availableModel) {
                console.log("No recommended models available - skipping inference test");
                return true; // Pass if no models
            }
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ollamaQuery"])(availableModel, "Say 'Hello' in one word.", {
                    maxTokens: 10,
                    timeout: 10000
                });
    ...
    // Test 7: Model recommendations
    {
        ...
        fn: ()=>{
            console.log("Recommended models:", __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OLLAMA_MODELS"].map((m)=>m.name));
            return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$llm$2f$ollamaClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["OLLAMA_MODELS"].length === 4;
        },
        category: "ollama"
    },
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$_$5f$tests_$5f2f$audit$2e$test$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/__tests__/audit.test.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$_$5f$tests_$5f2f$validation$2e$test$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/__tests__/validation.test.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$_$5f$tests_$5f2f$ollama$2e$test$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/__tests__/ollama.test.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function TestRunnerPage() {
    ...
    const [auditResults, setAuditResults] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [ollamaResults, setOllamaResults] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const runTests = async ()=>{
        ...
        try {
            ...
            // Run Audit tests
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$_$5f$tests_$5f2f$audit$2e$test$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["runAuditTests"])();
                setAuditResults(true);
            } catch (auditError) {
                setAuditResults(false);
            }
            // Run Validation tests
            const validationTestResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$_$5f$tests_$5f2f$validation$2e$test$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["runValidationTests"])();
            ...
            // Run Ollama tests
            const ollamaTestResults = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$_$5f$tests_$5f2f$ollama$2e$test$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["runOllamaTests"])();
            setOllamaResults({
            ...
            children: [
                ...
                validationResults && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-2",
                            children: validationResults.results.map((result, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: `flex items-start gap-3 p-3 rounded ${result.pass ? "bg-green-50" : "bg-red-50"}`,
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                            className: "text-xl",
                ...
                ollamaResults && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-surface border border-border rounded-lg p-6 mb-6",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                            className: "text-h2 font-semibold text-textMain mb-4",
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "space-y-2",
                            children: ollamaResults.results.map((result, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9af593df._.js.map