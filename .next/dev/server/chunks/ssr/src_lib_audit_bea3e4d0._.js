module.exports = [
"[project]/src/lib/audit/types.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/audit/logger.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ async function flushAuditBatch() {
    ...
    auditBatch = [];
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$persistence$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDatabase"])(); // Ensure DB is initialized
        for (const event of eventsToFlush){
            // Store event (encryption handled at storage layer)
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$persistence$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addToStore"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$persistence$2f$storage$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STORES"].AUDIT, event);
        }
...
"[project]/src/lib/audit/index.ts [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

/**
 * Audit Module - Public API
 */ __turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/audit/types.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/audit/logger.ts [app-ssr] (ecmascript)");
;
;
}),
"[project]/src/lib/audit/index.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "DEFAULT_RETENTION",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DEFAULT_RETENTION"],
    "cleanupAuditLogs",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cleanupAuditLogs"],
    "exportAuditLogs",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["exportAuditLogs"],
    "flushAuditLogs",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["flushAuditLogs"],
    "logAudit",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logAudit"],
    "logClinicalDecision",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logClinicalDecision"],
    "logSafetyEscalation",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logSafetyEscalation"],
    "queryAuditLogs",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["queryAuditLogs"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/lib/audit/index.ts [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/audit/types.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$audit$2f$logger$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/audit/logger.ts [app-ssr] (ecmascript)");
}),
];

//# sourceMappingURL=src_lib_audit_bea3e4d0._.js.map