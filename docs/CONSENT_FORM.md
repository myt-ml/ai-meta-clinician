# Informed Consent for AI Meta Clinician Use

**Version:** 1.0.0  
**Effective Date:** October 31, 2025  
**Language:** English (Arabic version available)

---

## Introduction

Thank you for considering the AI Meta Clinician for mental health support. This consent form explains what this system is, how it works, what it can and cannot do, and your rights as a user. **Please read this carefully before using the system.**

---

## What is the AI Meta Clinician?

The AI Meta Clinician is a computerized mental health screening and support tool. It:

- Uses artificial intelligence (AI) to provide responses based on WHO mental health guidelines
- Screens for common mental health concerns (depression, anxiety, stress)
- Provides evidence-based recommendations and psychoeducation
...
- **No cloud sync:** Cannot be accessed from other devices
...
- **No sharing:** We never share your data with anyone
...
- **Privacy concerns:** Data is on your device (physical access risk)
...
- Clinical supervision of system outputs (in supervised settings)
- Regular testing and updates for accuracy
...
4. **Seek alternatives** - Use other mental health resources
5. **File complaints** - Report concerns about the system
6. **Access your data** - View and download all stored information
7. **Delete your data** - Remove all records permanently
...
4. **Device security** - Protect your device from unauthorized access
5. **Understanding limitations** - Recognize what the system cannot do

---

## Clinical Supervision

In healthcare settings, this system is used under clinical supervision:

- A licensed mental health professional oversees the system
- Outputs are reviewed for clinical appropriateness
- Escalation pathways to human clinicians exist
- Regular audits ensure safety and quality
- Incident reporting captures any concerns

**Ask your provider about supervision arrangements in your setting.**
...
- 90 days after your last use (automatic data deletion)
...
**By clicking "I Agree" or using this system, you confirm that:**
...
- [ ] I know to call 988 or 911 in an emergency
- [ ] I understand my data is stored locally and encrypted
- [ ] I understand the AI may make mistakes
- [ ] I can withdraw my consent and delete my data at any time
- [ ] I am at least 13 years old (or have parental consent if under 18)
- [ ] I voluntarily choose to use this system

**If you do not agree with these terms, please do not use this system.**
...
You will be notified of significant changes and asked to re-consent.
...
**For questions about this consent form, contact:**  
[Deploying Organization Contact Information]

**For immediate mental health emergencies:**  
Call 988 (USA) or your local emergency number
