# Risk Disclosure: AI Meta Clinician
...
- Generating responses that don't apply to your situation
...
- Encrypt and log all interactions for review
...
- Determine disability or fitness for work
...
- Refer you to appropriate professional help
- Detect crisis situations and provide emergency resources

**If you need diagnosis or treatment, see a licensed professional.**
...
- Data recovery tools might retrieve deleted information

**If your device is compromised, assume your mental health data may be exposed.**
...
- Uses ~6 GB disk space for AI models
...
- Idioms and slang may be misunderstood
- Translation quality varies

**If the system doesn't meet your needs, seek professional help elsewhere.**

---

### 6. Clinical Supervision Requirements
...
- Seek professional help for clinical decisions

**If you're in a healthcare setting, ask about supervision arrangements.**
...
**Mental health is complex and individual. Outcomes depend on many factors beyond this system's control.**
...
### 10. Liability and Legal Limitations
...
- Misunderstanding or misinterpretation of responses
- Third-party interference or hacking
...
### Scenario 1: Crisis Misdetection
...
**Never change medications based on this system.**  
**Always consult your doctor or psychiatrist.**
...
- Don't share their information without consent

---

### Scenario 4: Cultural Mismatch
...
### Scenario 5: Misunderstanding Severity
...
- Screening scores don't align with how you feel

**Always prioritize your own experience and seek professional validation.**

---

## Your Acknowledgment of Risks

**By using this system, you acknowledge that you understand:**

- [ ] This is NOT an emergency service (call 988/911 for emergencies)
- [ ] This is NOT a replacement for professional mental health care
- [ ] AI can make mistakes and may provide incorrect information
- [ ] System cannot diagnose, prescribe, or treat mental illness
- [ ] Privacy risks exist despite encryption and security measures
- [ ] System has technical, clinical, and language limitations
- [ ] Clinical supervision may or may not be present
- [ ] No guarantees are made about outcomes or efficacy
- [ ] Your data may be used for quality improvement
- [ ] System may change without prior notice
- [ ] Use is at your own risk with limited liability
- [ ] I should seek professional help for serious concerns

**If you do not understand or accept these risks, do not use this system.**
...
- You rely on this system instead of professional care
- You feel the system is not helping
- Technical issues prevent safe use

**Remember: This is a tool, not a treatment. Professional help is always preferred for serious mental health concerns.**
...
**For clarification:**  
[System Administrator or Clinical Supervisor Contact]
